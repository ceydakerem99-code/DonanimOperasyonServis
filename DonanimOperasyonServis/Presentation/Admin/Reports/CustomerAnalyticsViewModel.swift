...
#if DEBUG
extension CustomerAnalyticsViewModel {
    static func previewReady() -> CustomerAnalyticsViewModel {
        let vm = CustomerAnalyticsViewModel(
        ...
        vm.customers = [
            Customer(
                ...
                address: "Merkez Mah.",
                city: "İstanbul",
                createdByUserId: AdminPreviewData.adminUser.id,
