...
final class DonanimOperasyonServisTests: XCTestCase {
    ...
    func testDIContainerMockWiresEveryRepository() {
        ...
        XCTAssertNotNil(container.reconciliationEngine)
        XCTAssertNotNil(container.conflictResolver)
        XCTAssertNotNil(container.networkReachability)
        XCTAssertNotNil(container.syncRecoveryHandler)
